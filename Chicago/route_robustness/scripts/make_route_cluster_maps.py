"""Build Leaflet maps for Chicago route clusters by route pair."""
...
def html_template(payload):
    ...
    title = f"Chicago Route Clusters - {payload['routeLabel']}"
...
<body>
  ...
  <main id="map" aria-label="Chicago route cluster map"></main>
...
def main():
    """Create one Leaflet route-cluster map for each Chicago route pair."""
