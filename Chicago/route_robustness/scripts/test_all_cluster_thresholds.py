...
SIMILARITY_PAIRS_CSV = "Chicago/route_robustness/output/cluster_assignments/all_route_similarity_pairs.csv"
OUTPUT_FOLDER = "Chicago/route_robustness/output/analysis"
