...
OUTPUT_FOLDER = "Chicago/route_robustness/output/direct_routes"
OUTPUT_CSV = "Chicago/route_robustness/output/direct_routes/direct_route_weight_configurations.csv"
