...
PILOT_ROUTES_GEOJSON = "Chicago/route_robustness/output/weighted_routes/pilot_routes.geojson"
PILOT_ROUTE_CLUSTERS_CSV = "Chicago/route_robustness/output/cluster_assignments/pilot_route_clusters.csv"
