...
PILOT_ROUTES_GEOJSON = "Chicago/route_robustness/output/pilot_routes.geojson"
PILOT_ROUTE_CLUSTERS_CSV = "Chicago/route_robustness/output/pilot_route_clusters.csv"
