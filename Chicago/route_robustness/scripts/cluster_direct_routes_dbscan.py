"""Cluster direct routes using DBSCAN with Frechet distance."""
...
OUTPUT_CSV = "Chicago/route_robustness/output/cluster_assignments/direct_route_clusters_dbscan.csv"
