...
PILOT_ROUTE_RUNS_CSV = "Chicago/route_robustness/output/weighted_routes/pilot_route_runs.csv"
SIMILARITY_PAIRS_CSV = "Chicago/route_robustness/output/cluster_assignments/pilot_route_similarity_pairs.csv"
